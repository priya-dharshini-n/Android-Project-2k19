...
import static com.android.priya.client.R.id.youtube_player_view;
...
public class CustomPlayerControlActivity extends YouTubeBaseActivity implements OnInitializedListener, View.OnClickListener {
    ...
    public static final String API_KEY = "AIzaSyBvNtErx7Ehyby3Bmdfko_0HZBJnE6yCdU";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        YouTubePlayerView youTubePlayerView = findViewById(youtube_player_view);
        ...
        mPlayTimeTextView.isInEditMode();
